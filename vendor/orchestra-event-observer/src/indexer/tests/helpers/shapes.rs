...
///        \  B2(4)  -  C2(5)
///
pub fn get_vector_004() -> Vec<StacksBlockData> {
    vec![
        blocks::A1(),
        blocks::B1(),
        blocks::C1(),
...
///        \  B2(4)  -  C2(5)
///
pub fn get_vector_006() -> Vec<StacksBlockData> {
    vec![
        blocks::A1(),
        blocks::B1(),
        blocks::C1(),
...
///        \  B2(4)  -  C2(5)
///
pub fn get_vector_007() -> Vec<StacksBlockData> {
    vec![
        blocks::A1(),
        blocks::B1(),
        blocks::C1(),
...
///        \  B2(4)  -  C2(5)
///
pub fn get_vector_008() -> Vec<StacksBlockData> {
    vec![
        blocks::A1(),
        blocks::B1(),
        blocks::C1(),
...
///        \  B2(4)  -  C2(5)
///
pub fn get_vector_009() -> Vec<StacksBlockData> {
    vec![
        blocks::A1(),
        blocks::B1(),
        blocks::C1(),
...
///        \  B2(4)  -  C2(5)  -  D2(11)
///
pub fn get_vector_010() -> Vec<StacksBlockData> {
    vec![
        blocks::A1(),
        blocks::B1(),
        blocks::C1(),
...
///        \  B2(4)  -  C2(5)
///
pub fn get_vector_011() -> Vec<StacksBlockData> {
    vec![
        blocks::A1(),
        blocks::B1(),
        blocks::C1(),
...
///        \  B2(4)  -  C2(5)
///
pub fn get_vector_012() -> Vec<StacksBlockData> {
    vec![
        blocks::A1(),
        blocks::B1(),
        blocks::C1(),
...
///        \  B2(4)  -  C2(5)
///
pub fn get_vector_013() -> Vec<StacksBlockData> {
    vec![
        blocks::A1(),
        blocks::B1(),
        blocks::C1(),
...
///        \  B2(4)  -  C2(5)
///
pub fn get_vector_014() -> Vec<StacksBlockData> {
    vec![
        blocks::A1(),
        blocks::B1(),
        blocks::C1(),
