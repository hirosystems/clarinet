...
use super::super::args::TestFlags;
use super::super::args::TypeCheckMode;
use super::super::checksum;
use super::super::compat;
use super::super::create_main_worker;
use super::super::display;
use super::super::file_fetcher::File;
use super::super::file_watcher;
use super::super::file_watcher::ResolutionResult;
use super::super::fmt_errors::format_js_error;
use super::super::fs_util::collect_specifiers;
use super::super::fs_util::is_supported_test_ext;
use super::super::fs_util::is_supported_test_path;
            ...
            for (origin, (failures, uncaught_error)) in failures_by_origin {
                for (description, js_error) in failures {
                    let failure_title = format!(
                        ...
                        colors::gray(format!(
                            "=> {}:{}:{}",
                            self.to_relative_path_or_remote_url(&description.location.file_name),
...
impl TestEventSender {
    ...
    pub fn send(&mut self, message: TestEvent) -> Result<(), AnyError> {
        ...
        if matches!(
            message,
            TestEvent::Result(_, _, _) | TestEvent::StepWait(_) | TestEvent::StepResult(_, _, _)
        ) {
