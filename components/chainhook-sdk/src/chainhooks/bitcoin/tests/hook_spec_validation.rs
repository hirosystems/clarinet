...
lazy_static! {
    ...
    static ref DESCRIPTOR_KEY_SHORT_ERR: String = "invalid predicate for scope 'outputs': invalid descriptor: unexpected «Key too short (<66 char), doesn't match any format»".into();
