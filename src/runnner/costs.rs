...
pub fn display_costs_report(sessions_artifacts: &mut Vec<SessionArtifacts>) {
    // TODO(lgalabru)
    ...
    // for artifacts in sessions_artifacts.drain(..) {
    //     for report in artifacts.coverage_reports.into_iter() {
    //         for (contract_id, report) in report.contracts_coverage.into_iter() {
