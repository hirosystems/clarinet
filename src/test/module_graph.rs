...
use super::ast;
use super::ast::parse;
use super::ast::transpile_module;
use super::ast::BundleHook;
use super::ast::Location;
use super::ast::ParsedModule;
use super::checksum;
use super::colors;
...
use super::specifier_handler::CachedModule;
use super::specifier_handler::Dependency;
use super::specifier_handler::DependencyMap;
use super::specifier_handler::Emit;
use super::specifier_handler::FetchFuture;
use super::specifier_handler::SpecifierHandler;
use super::tsc;
use super::tsc_config::IgnoredCompilerOptions;
use super::tsc_config::TsConfig;
use super::version;
...
fn get_version(source: &str, version: &str, config: &[u8]) -> String {
  super::checksum::gen(&[source.as_bytes(), version.as_bytes(), config])
}
