...
For more information on assertions, review [asserts](https://deno.land/std@0.90.0/testing/asserts.ts) in the Deno standard library. For more information on the available Clarity calls in Deno, review the [Deno Clarinet library](https://github.com/hirosystems/clarinet/blob/develop/components/clarinet-deno/index.ts). For more information on testing Clarity contracts, review the [Test Contract How-to Guide](https://docs.hiro.so/clarinet/how-to-guides/how-to-test-contract).
