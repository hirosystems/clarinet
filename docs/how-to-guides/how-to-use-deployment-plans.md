...
![deployment-plans](../images/deployment-plan-blocks-short.png)
...
Recall that a default deployment plan is used for every deployment, comprising your projects specifications as set in your `Clarinet.toml` and `Devnet.toml` files.
