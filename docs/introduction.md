...
> See our guide to learn how to [test smart contract](./how-to-guides/how-to-test-contract-with-clarinet-sdk.md). The SDK API reference is also available [here](./feature-guides//clarinet-js-sdk.md)
